...
public class Delete_kno_Servlet extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		String sql = "delete from Health_Knowledge  where  KnoName='"+delete_name+"'";
		stmt.executeUpdate(sql);
		String sql_tag = "delete from Tag_AND_Knowledge  where KnoName='"+delete_name+"'";
		stmt.executeUpdate(sql_tag);
		Statement stmt_kno_in = conn.createStatement();
		String sql_kno_in = "select * from Recommend_kno where KnoName='"+delete_name+"'";
	    ResultSet rs_kno_in = stmt_kno_in.executeQuery(sql_kno_in);
	    if(rs_kno_in.next()){
	    	String sql_recommend = "delete from Recommend_kno where  KnoName='"+delete_name+"'";
