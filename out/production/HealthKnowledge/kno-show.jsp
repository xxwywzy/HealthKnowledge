...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="background:#30a5ff;height:50px">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <img style="height:80px;padding-bottom:40px;padding-top:10px;" class="navbar-brand"
...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        ...
        <li class="active"><a href="kno-show.jsp">
            <svg
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body tabs">
                                        ...
                                        <%
                                            ...
                                            String sql_tag_forhypertension = "select TagName from KnoTag where TagType = '高血压'";
                                        ...
                                        %>
                                        <li><a href="#tab<%=tag_size_for_hypertension%>"
                                               data-toggle="tab"><%=rs_tag_forhypertension.getString("TagName")%>
                                        </a></li>
                                        <%
                                            }
                                    ...
                                    <div class="tab-content">
                                        <%
                                            ...
                                            String sql_tag_forhypertension_new = "select TagName from KnoTag where TagType = '高血压'";
                                        ...
                                        <div class="tab-pane fade" id="tab<%=size_for_hypertension%>">
                                            <%
                                                ...
                                                String sql_hypertension_kno = "select KnoName from KnoTagRelation where TagName = '" + kno_name + "' and TagType = '高血压'";
                                                ...
                                                while (rs_hypertension_kno.next()) {
                                                    ...
                                                    String sql_hypertension_kno_concrete = "select * from HealthKno where KnoName = '" + rs_hypertension_kno.getString("KnoName") + "'";
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-headingnew">
                                                        <%
                                                            ...
                                                            int ifReleased = rs_hypertension_kno_concrete.getInt("IfReleased");
                                                            String ifPush = "已推送";
                                                            if(ifReleased == 0){
                                                                ifPush = "未推送";
                                                            }
                                                        ...
                                                        <p class="kno_name" text align="left"
                                                           style="cursor:pointer"><%=name1%>
                                                        </p>
                                                        <p class="kno_content_link"
                                                           style="display:none"><%=kno_content_link1%>
                                                        </p>
                                                    </div>
                                                    <div class="panel-body">
                                                        <p class="kno_time" text align="left"
                                                           style="height:10px;font-size:10px;margin-bottom:10px"><%=rs_hypertension_kno_concrete.getString("KnoTime").substring(0, 16)%>  <%=ifPush%>
                                                        </p>
                                                        <img class="kno_pic"
                                                             src="<%=rs_hypertension_kno_concrete.getString("KnoLink")%>"
                                                             width="100%" height="150px"/>
                                                        <p class="kno_dis"
                                                           style="margin-top:10px"><%=rs_hypertension_kno_concrete.getString("KnoDiscription")%>
                                                        </p>
                                                        <div class="content"
                                                             style="display:none"><%=rs_hypertension_kno_concrete.getString("KnoElaboration")%>
                                                        </div>
                                                        <hr/>
                                ...
                                <div class="panel-body tabs">
                                    <ul class="nav nav-tabs">
                                        <%
                                            ...
                                            String sql_tag_fordiabete = "select TagName from KnoTag where TagType = '糖尿病'";
                                        ...
                                        %>
                                        <li><a href="#tab<%=tag_size_for_diabete%>"
                                               data-toggle="tab"><%=rs_tag_fordiabete.getString("TagName")%>
                                        </a></li>
                                        <%
                                            }
                                    ...
                                    <div class="tab-content">
                                        <%
                                            ...
                                            String sql_tag_fordiabete_new = "select TagName from KnoTag where TagType = '糖尿病'";
                                        ...
                                        <div class="tab-pane fade" id="tab<%=size_for_diabete%>">
                                            <%
                                                ...
                                                String sql_diabete_kno = "select KnoName from KnoTagRelation where TagName = '" + kno_name + "' and TagType = '糖尿病'";
                                                ...
                                                while (rs_diabete_kno.next()) {
                                                    ...
                                                    String sql_diabete_kno_concrete = "select * from HealthKno where KnoName = '" + rs_diabete_kno.getString("KnoName") + "'";
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-headingnew">
                                                        <%
                                                            ...
                                                            int ifReleased2 = rs_diabete_kno_concrete.getInt("IfReleased");
                                                            String ifPush2 = "已推送";
                                                            if(ifReleased2 == 0){
                                                                ifPush2 = "未推送";
                                                            }
                                                        ...
                                                        <p class="kno_name" text align="left"
                                                           style="cursor:pointer"><%=name2%>
                                                        </p>
                                                        <p class="kno_content_link"
                                                           style="display:none"><%=kno_content_link2%>
                                                        </p>
                                                    </div>
                                                    <div class="panel-body">
                                                        <p class="kno_time" text align="left"
                                                           style="height:10px;font-size:10px;margin-bottom:10px"><%=rs_diabete_kno_concrete.getString("KnoTime").substring(0, 16)%>  <%=ifPush2%>
                                                        </p>
                                                        <img class="kno_pic"
                                                             src="<%=rs_diabete_kno_concrete.getString("KnoLink")%>"
                                                             width="100%" height="150px"/>
                                                        <p class="kno_dis"
                                                           style="margin-top:10px"><%=rs_diabete_kno_concrete.getString("KnoDiscription")%>
                                                        </p>
                                                        <div class="content"
                                                             style="display:none"><%=rs_diabete_kno_concrete.getString("KnoElaboration")%>
                                                        </div>
                                                        <hr/>
                                                        <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7" title="编辑">
                                                            <svg class="glyph stroked pencil"
                                ...
                                <div class="panel-body tabs">
                                    <ul class="nav nav-tabs">
                                        <%
                                            ...
                                            String sql_tag_forhyperlipemia = "select TagName from KnoTag where TagType = '高血脂'";
                                        ...
                                        %>
                                        <li><a href="#tab<%=tag_size_for_hyperlipidemia%>"
                                               data-toggle="tab"><%=rs_tag_forhyperlipemia.getString("TagName")%>
                                        </a></li>
                                        <%
                                            }
                                    ...
                                    <div class="tab-content">
                                        <%
                                            ...
                                            String sql_tag_forhyperlipemia_new = "select TagName from KnoTag where TagType = '高血脂'";
                                        ...
                                        <div class="tab-pane fade" id="tab<%=size_for_hyperlipidemia%>">
                                            <%
                                                ...
                                                String sql_hyperlipemia_kno = "select KnoName from KnoTagRelation where TagName = '" + kno_name + "' and TagType = '高血脂'";
                                                ...
                                                while (rs_hyperlipemia_kno.next()) {
                                                    ...
                                                    String sql_hyperlipemia_kno_concrete = "select * from HealthKno where KnoName = '" + rs_hyperlipemia_kno.getString("KnoName") + "'";
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-headingnew">
                                                        <%
                                                            ...
                                                            int ifReleased3 = rs_hyperlipemia_kno_concrete.getInt("IfReleased");
                                                            String ifPush3 = "已推送";
                                                            if(ifReleased3 == 0){
                                                                ifPush3 = "未推送";
                                                            }
                                                        ...
                                                        <p class="kno_name" text align="left"
                                                           style="cursor:pointer"><%=name3%>
                                                        </p>
                                                        <p class="kno_content_link"
                                                           style="display:none"><%=kno_content_link3%>
                                                        </p>
                                                    </div>
                                                    <div class="panel-body">
                                                        <p class="kno_time" text align="left"
                                                           style="height:10px;font-size:10px;margin-bottom:10px"><%=rs_hyperlipemia_kno_concrete.getString("KnoTime").substring(0, 16)%>  <%=ifPush3%>
                                                        </p>
                                                        <img class="kno_pic"
                                                             src="<%=rs_hyperlipemia_kno_concrete.getString("KnoLink")%>"
                                                             width="100%" height="150px"/>
                                                        <p class="kno_dis"
                                                           style="margin-top:10px"><%=rs_hyperlipemia_kno_concrete.getString("KnoDiscription")%>
                                                        </p>
                                                        <div class="content"
                                                             style="display:none"><%=rs_hyperlipemia_kno_concrete.getString("KnoElaboration")%>
                                                        </div>
                                                        <hr/>
                                                        <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7" title="编辑">
                                                            <svg class="glyph stroked pencil"
                                ...
                                <div class="panel-body tabs">
                                    <ul class="nav nav-tabs">
                                        <%
                                            ...
                                            String sql_tag_forchd = "select TagName from KnoTag where TagType = '冠心病'";
                                        ...
                                        %>
                                        <li><a href="#tab<%=tag_size_for_chd%>"
                                               data-toggle="tab"><%=rs_tag_forchd.getString("TagName")%>
                                        </a></li>
                                        <%
                                            }
                                            rs_tag_forchd.close();
                                    ...
                                    <div class="tab-content">
                                        <%
                                            ...
                                            String sql_tag_forchd_new = "select TagName from KnoTag where TagType = '冠心病'";
                                        ...
                                        <div class="tab-pane fade" id="tab<%=size_for_chd%>">
                                            <%
                                                ...
                                                String sql_chd_kno = "select KnoName from KnoTagRelation where TagName = '" + kno_name + "' and TagType = '冠心病'";
                                                ...
                                                while (rs_chd_kno.next()) {
                                                    ...
                                                    String sql_chd_kno_concrete = "select * from HealthKno where KnoName = '" + rs_chd_kno.getString("KnoName") + "'";
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-headingnew">
                                                        <%
                                                            ...
                                                            int ifReleased4 = rs_chd_kno_concrete.getInt("IfReleased");
                                                            String ifPush4 = "已推送";
                                                            if(ifReleased4 == 0){
                                                                ifPush4 = "未推送";
                                                            }
                                                        ...
                                                        <p class="kno_name" text align="left"
                                                           style="cursor:pointer"><%=name4%>
                                                        </p>
                                                        <p class="kno_content_link"
                                                           style="display:none"><%=kno_content_link4%>
                                                        </p>
                                                    </div>
                                                    <div class="panel-body">
                                                        <p class="kno_time" text align="left"
                                                           style="height:10px;font-size:10px;margin-bottom:10px"><%=rs_chd_kno_concrete.getString("KnoTime").substring(0, 16)%>  <%=ifPush4%>
                                                        </p>
                                                        <img class="kno_pic"
                                                             src="<%=rs_chd_kno_concrete.getString("KnoLink")%>"
                                                             width="100%" height="150px"/>
                                                        <p class="kno_dis"
                                                           style="margin-top:10px"><%=rs_chd_kno_concrete.getString("KnoDiscription")%>
                                                        </p>
                                                        <div class="content"
                                                             style="display:none"><%=rs_chd_kno_concrete.getString("KnoElaboration")%>
                                                        </div>
                                                        <hr/>
                                                        <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7" title="编辑">
                                                            <svg class="glyph stroked pencil"
                                ...
                                <div class="panel-body tabs">
                                    <ul class="nav nav-tabs">
                                        <%
                                            ...
                                            String sql_tag_forstroke = "select TagName from KnoTag where TagType = '脑卒中'";
                                        ...
                                        %>
                                        <li><a href="#tab<%=tag_size_for_stroke%>"
                                               data-toggle="tab"><%=rs_tag_forstroke.getString("TagName")%>
                                        </a></li>
                                        <%
                                            }
                                    ...
                                    <div class="tab-content">
                                        <%
                                            ...
                                            String sql_tag_forstroke_new = "select TagName from KnoTag where TagType = '脑卒中'";
                                        ...
                                        <div class="tab-pane fade" id="tab<%=size_for_stroke%>">
                                            <%
                                                ...
                                                String sql_stroke_kno = "select KnoName from KnoTagRelation where TagName = '" + kno_name + "' and TagType = '脑卒中'";
                                                ...
                                                while (rs_stroke_kno.next()) {
                                                    ...
                                                    String sql_stroke_kno_concrete = "select * from HealthKno where KnoName = '" + rs_stroke_kno.getString("KnoName") + "'";
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-headingnew">
                                                        <%
                                                            ...
                                                            int ifReleased5 = rs_stroke_kno_concrete.getInt("IfReleased");
                                                            String ifPush5 = "已推送";
                                                            if(ifReleased5 == 0){
                                                                ifPush5 = "未推送";
                                                            }
                                                        ...
                                                        <p class="kno_name" text align="left"
                                                           style="cursor:pointer"><%=name5%>
                                                        </p>
                                                        <p class="kno_content_link"
                                                           style="display:none"><%=kno_content_link5%>
                                                        </p>
                                                    </div>
                                                    <div class="panel-body">
                                                        <p class="kno_time" text align="left"
                                                           style="height:10px;font-size:10px;margin-bottom:10px"><%=rs_stroke_kno_concrete.getString("KnoTime").substring(0, 16)%>  <%=ifPush5%>
                                                        </p>
                                                        <img class="kno_pic"
                                                             src="<%=rs_stroke_kno_concrete.getString("KnoLink")%>"
                                                             width="100%" height="150px"/>
                                                        <p class="kno_dis"
                                                           style="margin-top:10px"><%=rs_stroke_kno_concrete.getString("KnoDiscription")%>
                                                        </p>
                                                        <div class="content"
                                                             style="display:none"><%=rs_stroke_kno_concrete.getString("KnoElaboration")%>
                                                        </div>
                                                        <hr/>
                                                        <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7" title="编辑">
                                                            <svg class="glyph stroked pencil"
                                    ...
                                    <form method="post" action=Delete_kno_Servlet>
                                        <div class="modal-body">
                                            ...
                                            <br> <input type=hidden
                                                        style="width:1px;height:1px" name="name_deleted"/>
                                        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <form method="post" action=Update_kno_Servlet>
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <label>知识简单描述</label>
                                                <textarea class="form-control" style="width:350px;height:60px"
                                                          name="dis_updated"></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label>知识内容</label>
                                                <textarea id="content_input" class="form-control"
                                                          style="width:350px;height:300px"
                                                          name="con_updated"></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label>图片链接</label>
                                                <textarea class="form-control" style="width:350px;height:50px"
                                                          name="link_updated"></textarea>
                                            </div>
                                            <input type=hidden
                                                   style="width:1px;height:1px" name="name_before"/>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-default"
                                                    data-dismiss="modal">关闭
