													...
													<div class="panel panel-default">
														<div class="panel-headingnew">
														 <%
														      ...
														      String link1 = "http://localhost:8080/health-knowledge/kno-content.jsp?kno_name=";
														...
														<div class="panel-body">
															...
															<input type="hidden" style="width:1px;height:1px"
																class="kno_content"
																value="<%=rs_hypertension_kno_concrete.getString("KnoElaboration")%>"></input>
														<hr/>
												...
												<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
													<div class="panel panel-default">
														...
														<div class="panel-body">
															...
															<input type="hidden" style="width:1px;height:1px"
																class="kno_content"
																value="<%=rs_diabete_kno_concrete.getString("KnoElaboration")%>"></input>
														<hr/>
														<div class="col-xs-7 col-sm-7 col-md-7 col-lg-7" title="编辑">
														<svg class="glyph stroked pencil"
																style="height:23px;cursor:pointer;color:#006400">
												...
												<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
													<div class="panel panel-default">
														...
														<div class="panel-body">
															...
															<input type="hidden" style="width:1px;height:1px"
																class="kno_content"
																value="<%=rs_hyperlipemia_kno_concrete.getString("KnoElaboration")%>"></input>
														<hr/>
														<div class="col-xs-7 col-sm-7 col-md-7 col-lg-7" title="编辑">
														<svg class="glyph stroked pencil"
																style="height:23px;cursor:pointer;color:#006400">
												...
												<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
													<div class="panel panel-default">
														...
														<div class="panel-body">
															...
															<input type="hidden" style="width:1px;height:1px"
																class="kno_content"
																value="<%=rs_chd_kno_concrete.getString("KnoElaboration")%>"></input>
														<hr/>
														<div class="col-xs-7 col-sm-7 col-md-7 col-lg-7" title="编辑">
														<svg class="glyph stroked pencil"
																style="height:23px;cursor:pointer;color:#006400">
												...
												<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
													<div class="panel panel-default">
														...
														<div class="panel-body">
															...
															<input type="hidden" style="width:1px;height:1px"
																class="kno_content"
																value="<%=rs_stroke_kno_concrete.getString("KnoElaboration")%>"></input>
														<hr/>
														<div class="col-xs-7 col-sm-7 col-md-7 col-lg-7" title="编辑">
														<svg class="glyph stroked pencil"
																style="height:23px;cursor:pointer;color:#006400">
												...
												<div class="modal-dialog">
													<div class="modal-content">
														<div class="modal-header" style="background-color:#ff0000">
															...
															<h4 class="modal-title" id="myModalLabel"><font color="white">删除知识</font></h4>
														</div>
												...
												<div class="modal-dialog">
													<div class="modal-content">
														<div class="modal-header" style="background-color:#91d52b">
															<button type="button" class="close" data-dismiss="modal"
																aria-hidden="true" style="color:white">×</button>
															<h4 class="modal-title" id="myModalLabel"><font color="white">修改知识</font></h4>
														</div>
														<form method="post" action=Update_kno_Servlet>
															<div class="modal-body">
															  ...
															  <div class="form-group">	
																<label>知识内容</label>
																<textarea class="form-control" style="width:350px;height:300px" name="con_updated"></textarea>
															  </div>
															  <div class="form-group">
																<label>图片链接</label>
												...
												<div class="modal-dialog">
													<div class="modal-content">
														<div class="modal-header" style="background-color:#2bb3d5">
															<button type="button" class="close" data-dismiss="modal"
																aria-hidden="true" style="color:white">×</button>
															<h4 class="modal-title" id="myModalLabel"><font color="white">知识内容</font></h4>
														</div><br>
	...
	<script>
		$(function() {
			...
			btn.click(function() {
				...
				var dis = par.children(".kno_dis").text();
				var content = par.children(".kno_content").val();
